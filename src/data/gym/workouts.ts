...
export const WORKOUTS: GymWorkout[] = [
  // ── Неделя 1 ──────────────────────────────────────────────────────
  {
    ...
    exs: [
      { id: 'gym_chest_press_machine', sets: 3, reps: '8-10', weight: '20 кг' },
  ...
  // ── Неделя 2 — те же упражнения, повторы к верхней границе диапазона ──
  {
    ...
    exs: [
      { id: 'gym_chest_press_machine', sets: 3, reps: '10-12', weight: '20 кг' },
  ...
  // ── Неделя 3 — вес растёт, повторы сброшены к нижней границе, +1 подход на базовых ──
  {
    ...
    exs: [
      { id: 'gym_chest_press_machine', sets: 4, reps: '8-10', weight: '25 кг' },
