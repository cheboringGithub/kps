...
export const DAYS: Day[] = [
  ...
  { phase: 1, title: 'Углубление КПС', short: 'КПС × 3 упражнения',
    ...
    exs: ['warmup_knee', 'kps_decomp', 'kps_traction', 'figure4', 'glute_side_lying', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_pose'] },
  ...
  { phase: 1, title: 'Сгибатели + мост', short: 'ПП-мышца + мост',
    ...
    exs: ['warmup_march', 'il_lunge', 'kps_bridge', 'kps_decomp', 'figure4', 'side_lying_stretch', 'foot_peroneal', 'foot_outer', 'foot_short', 'savasana'] },

  { phase: 1, title: 'Боковая цепь день', short: 'Межрёберные + ТН',
    desc: 'Полный день на боковую цепь. КПС в роли декомпрессии до и после.',
    exs: ['warmup_knee', 'kps_decomp', 'side_lying_stretch', 'it_side_lying', 'glute_clamshell', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_pose'] },
  ...
  { phase: 1, title: 'Хамстринги — шаг вперёд', short: 'Задняя поверхность',
    ...
    exs: ['warmup_march', 'kps_traction', 'hamstring_standing', 'hamstring_seated', 'figure4', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_pose'] },
  ...
  { phase: 1, title: '90/90 — дебют', short: 'КПС × 90/90',
    ...
    exs: ['warmup_knee', 'kps_decomp', 'kps_90_90', 'figure4', 'glute_side_lying', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_wide'] },
  ...
  { phase: 1, title: 'Активация ягодичных', short: 'Средняя ягодичная',
    ...
    exs: ['warmup_march', 'glute_clamshell', 'glute_side_lying', 'glute_bridge_single', 'kps_decomp', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'savasana'] },
  ...
  { phase: 1, title: 'Итог фазы 1', short: 'Лучшее из двух недель',
    ...
    exs: ['warmup_knee', 'kps_decomp', 'kps_90_90', 'il_lunge', 'figure4', 'side_lying_stretch', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_wide'] },
  ...
  { phase: 2, title: 'Подвздошно-поясничная — углубление', short: 'ПП-мышца фокус',
    ...
    exs: ['warmup_hip_circle', 'kps_decomp', 'il_lunge_adv', 'kps_90_90', 'figure4', 'glute_clamshell', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_pose'] },
  ...
  { phase: 2, title: 'Мост — продвинутый', short: 'Одноножный мост',
    ...
    exs: ['warmup_knee', 'kps_traction', 'glute_bridge_single', 'figure4_adv', 'it_side_lying', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'savasana'] },
  ...
  { phase: 2, title: 'Поза голубя — дебют', short: 'Голубь подготовительный',
    ...
    exs: ['warmup_hip_circle', 'kps_decomp', 'kps_figure4_floor', 'il_lunge_adv', 'glute_side_lying', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_wide'] },
  ...
  { phase: 2, title: 'Широкий наклон', short: 'Хамстринги врозь',
    ...
    exs: ['warmup_knee', 'kps_decomp', 'hamstring_wide', 'kps_90_90', 'figure4_adv', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_pose'] },
  ...
  { phase: 2, title: 'Симметрия таза', short: 'Коррекция перекоса',
    ...
    exs: ['warmup_march', 'kps_traction', 'il_lunge', 'glute_bridge_single', 'it_side_lying', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'savasana'] },
  ...
  { phase: 2, title: 'Бабочка и пах', short: 'Паховые связки',
    ...
    exs: ['warmup_hip_circle', 'kps_decomp', 'butterfly_forward', 'kps_figure4_floor', 'glute_clamshell', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_pose'] },
  ...
  { phase: 2, title: 'Сумо-приседание', short: 'Тазобедренный сустав',
    ...
    exs: ['warmup_knee', 'kps_bridge', 'squat_sumo', 'figure4_adv', 'it_side_lying', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_wide'] },
  ...
  { phase: 2, title: 'ПНФ — первый раз', short: 'ПНФ хамстринги',
    ...
    exs: ['warmup_hip_circle', 'kps_decomp', 'hamstring_pnf', 'kps_90_90', 'glute_bridge_single', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'savasana'] },

  { phase: 2, title: 'Итог фазы 2', short: 'Интеграция',
    desc: 'Полный цикл фазы 2. Сравни ощущения в КПС с неделей 1.',
    exs: ['warmup_knee', 'kps_decomp', 'kps_figure4_floor', 'il_lunge_adv', 'hamstring_wide', 'glute_bridge_single', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_wide'] },
  ...
  { phase: 3, title: 'Боковая цепь — полный день', short: 'Боковые + ИТ-тяж',
    ...
    exs: ['warmup_hip_circle', 'kps_decomp', 'side_lying_stretch', 'it_side_lying', 'it_standing', 'kps_90_90', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_pose'] },

  { phase: 3, title: 'Голубь + ПНФ', short: 'КПС × ПНФ',
    desc: 'Поза голубя с техникой ПНФ — максимальное воздействие на КПС.',
    exs: ['warmup_knee', 'kps_traction', 'kps_figure4_floor', 'figure4_adv', 'hamstring_pnf', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'savasana'] },
  ...
  { phase: 3, title: 'Сумо + хамстринги', short: 'Глубина диапазона',
    ...
    exs: ['warmup_hip_circle', 'kps_decomp', 'squat_sumo', 'hamstring_wide', 'glute_bridge_single', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_wide'] },
  ...
  { phase: 3, title: 'Выравнивание + активация', short: 'Симметрия таза',
    ...
    exs: ['warmup_march', 'kps_decomp', 'il_lunge_adv', 'glute_clamshell', 'it_side_lying', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'savasana'] },
  ...
  { phase: 3, title: 'ПНФ-наклон — прорыв', short: 'Ладони к полу',
    ...
    exs: ['warmup_knee', 'kps_traction', 'hamstring_pnf', 'kps_90_90', 'figure4_adv', 'kps_clock', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_pose'] },
  ...
  { phase: 3, title: 'Интеграция фазы 3', short: 'Всё вместе',
    ...
    exs: ['warmup_hip_circle', 'kps_decomp', 'kps_figure4_floor', 'it_standing', 'hamstring_wide', 'glute_bridge_single', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_wide'] },
  ...
  { phase: 4, title: 'Поддержание и закрепление', short: 'Фаза 4 старт',
    ...
    exs: ['warmup_hip_circle', 'kps_decomp', 'kps_90_90', 'kps_figure4_floor', 'hamstring_pnf', 'glute_bridge_single', 'foot_peroneal', 'foot_outer', 'foot_short', 'savasana'] },
  ...
  { phase: 4, title: 'День 30 — итог курса', short: 'Финал',
    ...
    exs: ['warmup_knee', 'kps_decomp', 'kps_traction', 'kps_90_90', 'kps_figure4_floor', 'hamstring_pnf', 'foot_peroneal', 'foot_outer', 'foot_short', 'child_wide'] },
]
